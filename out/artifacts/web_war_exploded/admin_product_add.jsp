            ...
            <form action="admin_product_add" method="post">
                <ul>
                    <li>
                        ...
                        <input type="text" class="input" placeholder=" 0-30个英文或汉字" name="product_name">
                    </li>
                    <li>
                        <label for="">商品价格：</label>
                        <input type="text" class="input" placeholder="5位数之内" name="product_price">
                    </li>
                    <li>
                        <label for="">商品数量：</label>
                        <input type="text" class="input" placeholder="5位数之内" name="product_num">
                    </li>
                    <li>
