...
<div class="frame">
  ...
  <div class="headline">
    ...
    <h3><span style="color: #1921b1">结算</span> </h3>
...
<div class="frame">
  <div class="register">
    ...
    <div class="account">
      ...
      <form action="user_products_account_click?id=${number}" method="post">
        <ul>
          <% int i =1;%>
          ...
          <li>
            ...
            <input type="text" class="input" disabled ="true" name="product_name" value=${product.p_describe}>
            <label for="">商品价格：</label>
            <input type="text" class="input" disabled ="true"  name="product_price" value=${product.p_price}>
          </li>
            <%i+=1;%>
          </c:forEach>
          ...
          <li>
            ...
            <label for=""></label>
            <label for="">价格总计：</label>
            <input type="text" class="input"  disabled ="true" name="sales" value=${sales}>
            <input type="submit" value="确认购买&nbsp;&nbsp;" class="btn" onClick="buy()">
          </li>
        </ul>
      </form>
    </div>
